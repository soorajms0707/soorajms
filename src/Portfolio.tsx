...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-slate-950/60 bg-slate-950/40 border-b border-slate-800">
...
const Hero = () => (
  <section id="home" className="relative overflow-hidden">
    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(14,165,233,0.2),transparent_50%),radial-gradient(ellipse_at_bottom_left,rgba(217,70,239,0.18),transparent_50%)]" />
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Button asChild className="gap-2">
              <a href="#projects"><ArrowRight className="h-4 w-4"/> Explore Projects</a>
            </Button>
            <Button asChild variant="secondary" className="gap-2">
              <a href="/resume.pdf" target="_blank" rel="noreferrer"><Download className="h-4 w-4"/> Download Resume</a>
            </Button>
          </div>
          ...
          <div className="mt-6 flex items-center gap-3">
            <Button asChild size="icon" variant="secondary"><a href="https://github.com/soorajms0707" target="_blank" rel="noreferrer"><Github className="h-4 w-4"/></a></Button>
        ...
        <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} className="relative">
          <div className="aspect-[4/5] rounded-2xl bg-slate-900/60 border border-slate-800 overflow-hidden shadow-2xl">
            ...
            <img src="/profile.png" alt="Sooraj" className="w-full h-full object-cover" />
          </div>
        </motion.div>
      </div>
      ...
      <Section id="about" title="About" subtitle="Designer of data systems, automation, and scraping toolchains with a quality-first mindset.">
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-slate-900/50 border-slate-800"><CardContent className="p-6">
            ...
            <p className="text-slate-300 mt-2">I build ETL/ELT pipelines, web data acquisition flows, and reliability layers (schema checks, validation, alerts). I enjoy making performance measurable and repeatable.</p>
          </CardContent></Card>
          <Card className="bg-slate-900/50 border-slate-800"><CardContent className="p-6">
            <div className="font-bold">How I work</div>
            <p className="text-slate-300 mt-2">Rapid prototyping → benchmarks → tighten loops. Prefer small, composable modules with solid logging/observability and clear contracts.</p>
          </CardContent></Card>
          <Card className="bg-slate-900/50 border-slate-800"><CardContent className="p-6">
            <div className="font-bold">Now</div>
            <p className="text-slate-300 mt-2">Exploring LLM‑assisted scraping and resilient anti‑bot strategies; improving my infra-as-code and data quality playbooks.</p>
          </CardContent></Card>
        </div>
      </Section>
      ...
      <Section id="experience" title="Experience" subtitle="Hands‑on roles where I shipped and learned the most.">
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-slate-900/50 border-slate-800"><CardContent className="p-6">
            <TimelineItem
              when="2023 – Present"
              what="Data Mining Engineer"
              where="Hashwave Technologies, Kerala, India"
              points={[
                "Developed robust scraping systems (Scrapy, Playwright, BeautifulSoup) and R&D PoCs.",
                "Automated data cleaning with Pandas/regex; increased speed and reliability.",
                "Researched AI‑driven methods for scraping & processing speed improvements.",
                "Built pipelines (MySQL, MongoDB); deployed/scaled on AWS & Azure; microservices integration.",
                "Optimized tools to handle site changes and bypass anti‑bot systems; mentored engineers.",
              ]}
            />
          </CardContent></Card>
          <Card className="bg-slate-900/50 border-slate-800"><CardContent className="p-6">
            <div className="font-bold mb-2">Achievements & Certifications</div>
            <ul className="list-disc pl-4 text-slate-300 space-y-1">
              <li>Python Web Development Expert (A+), NACTET (2023)</li>
              <li>Python Django‑Angular Full Stack Development (A+), Luminar Technolab (2023)</li>
              <li>Data Science A‑Z Completion (2022)</li>
            </ul>
          </CardContent></Card>
        </div>
      </Section>
