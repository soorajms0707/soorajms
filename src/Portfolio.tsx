...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-slate-950/60 bg-transparent/40 border-b border-slate-800">
      <motion.div
        style={{ scaleX }}
        className="h-1 bg-gradient-to-r from-cyan-400 via-sky-500 to-fuchsia-500 origin-left"
      />
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        >
          <Sparkles className="h-5 w-5 text-cyan-400" /> Sooraj{" "}
        ...
        <nav className="hidden md:flex items-center gap-4 text-sm">
          {[
            ...
            <a
              key={id as string}
              href={`#${id}`}
              className="px-3 py-1 rounded-md hover:bg-slate-800/60"
            >
              {label}
            </a>
          ))}
    ...
    <div className="max-w-6xl mx-auto px-4 pt-16 md:pt-24 pb-20">
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          >
            Data Engineer <span className="text-sky-400">&</span> AI Automation
            Specialist
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          <div className="mt-6 flex flex-wrap gap-4 text-sm text-slate-400">
            <div className="flex items-center gap-2">
              <Phone className="h-4 w-4" /> +91 9207970707
            </div>
            <a
              className="flex items-center gap-2 hover:text-slate-200"
              href="mailto:soorajms0707@gmail.com"
            >
              <Mail className="h-4 w-4" /> soorajms0707@gmail.com
            </a>
            <div className="flex items-center gap-2">
              <MapPin className="h-4 w-4" /> Kerala, India (open to remote)
            </div>
          </div>
          <div className="mt-6 flex items-center gap-3">
            ...
            <Button asChild size="icon" variant="secondary">
              <a
                href="https://www.linkedin.com/in/soorajms0707"
                target="_blank"
                rel="noreferrer"
              >
        ...
        >
          <div className="aspect-[4/5] rounded-2xl bg-slate-900/60 border border-slate-800 overflow-hidden shadow-2xl">
            {/* from public/profile.jpg (or .png) */}
            <img
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <Section
        id="about"
        title="About"
        subtitle="Designer of data systems, automation, and scraping toolchains with a quality-first mindset."
      >
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-slate-900/50 border-slate-800">
            <CardContent className="p-6">
              ...
              <p className="text-slate-300 mt-2">
                I design and build scalable data pipelines, AI automation
                systems, and intelligent scraping solutions.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-slate-900/50 border-slate-800">
            <CardContent className="p-6">
              ...
              <p className="text-slate-300 mt-2">
                I focus on clean, efficient, and reliable workflows, blending
                data engineering best practices with modern AI techniques.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-slate-900/50 border-slate-800">
            <CardContent className="p-6">
              ...
              <p className="text-slate-300 mt-2">
                Currently expanding my expertise in cloud platforms and AI-driven
                automation, while working on advanced anti-bot strategies.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <Section id="projects" title="Projects" subtitle="A few highlights. More on GitHub.">
        <div className="grid md:grid-cols-2 gap-6">
          {/* Anti-Scrape: links removed per your request */}
          <ProjectCard
          ...
          <ProjectCard
            ...
            links={[
              { label: "GitHub", href: "https://github.com/soorajms0707/Asus_laptop-website" },
            ]}
          />
          <ProjectCard
          ...
          <Card className="bg-slate-900/60 border-slate-800">
            <CardContent className="p-6">
              ...
              <ul className="mt-4 text-slate-300 list-disc pl-6 space-y-2">
                <li>
                  Led R&amp;D initiatives, delivering proof-of-concept tools to
                  solve complex data challenges.
                </li>
                <li>
                  Developed robust web scraping solutions using Scrapy,
                  Playwright, and BeautifulSoup.
                </li>
                <li>
                  Automated large-scale data cleaning with Pandas and regex for
                  faster, more accurate outputs.
                </li>
                <li>
                  Researched and implemented AI-driven methods to increase
                  scraping and processing speed.
                </li>
                <li>
                  Built and deployed data pipelines integrating MySQL and
                  MongoDB.
                </li>
                <li>
                  Optimized tools to adapt to site changes and bypass
                  CAPTCHA/anti-bot systems.
                </li>
                <li>
                  Mentored engineers and trained new hires, boosting team
                  capability and delivery speed.
                </li>
                <li>
                  Integrated REST APIs for seamless communication between
                  microservices and frontend systems.
                </li>
                <li>
                  Deployed and scaled pipelines on AWS and Azure for high
                  performance.
                </li>
                <li>
                  Performed code reviews to ensure clean, efficient, and
          ...
          <Card className="bg-slate-900/60 border-slate-800">
            <CardContent className="p-6">
              ...
              <p className="mt-2 text-slate-300">
                Vidya Academy of Science and Technology, Kerala, India
                (2018–2022)
              </p>
              <ul className="mt-4 text-slate-300 list-disc pl-6 space-y-2">
                <li>
                  Strong grounding in data structures, algorithms, databases, and
                  software engineering.
                </li>
                <li>
                  Workshops & academic projects focused on Python development,
      ...
      >
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-slate-900/60 border-slate-800">
            <CardContent className="p-6">
              ...
              <ul className="mt-3 text-slate-300 list-disc pl-6 space-y-2">
                <li>
                  Built full-stack web apps with Python, Django, HTML, CSS,
                  JavaScript.
                </li>
                <li>
                  Worked with REST APIs, modular coding, and Git version control.
                </li>
              </ul>
            </CardContent>
          </Card>
          <Card className="bg-slate-900/60 border-slate-800">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-slate-100">
                Python Django–Angular Full Stack Development (A+), Luminar
                Technolab — 2023
              </h3>
              <ul className="mt-3 text-slate-300 list-disc pl-6 space-y-2">
                <li>
                  Developed full-stack projects using Django backend with
                  responsive frontends.
                </li>
                <li>
                  Learned Angular fundamentals and component-based UI design.
                </li>
              </ul>
            </CardContent>
          </Card>
          <Card className="bg-slate-900/60 border-slate-800">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-slate-100">
                Internet of Things Using Raspberry Pi — 2019
              </h3>
              <p className="mt-3 text-slate-300">
                Built IoT applications with Raspberry Pi: sensors, data
          ...
          <Card className="bg-slate-900/60 border-slate-800">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-slate-100">
                Data Science A–Z Completion Certificate — 2022
              </h3>
              <p className="mt-3 text-slate-300">
                Covered preprocessing, analysis, visualization, and ML basics
                with Python.
              </p>
            </CardContent>
          </Card>
      ...
      <Section id="skills" title="Skills" subtitle="Tooling I use frequently and enjoy.">
        ...
        <div className="space-y-6 mt-6">
          {/* the detailed grouped skills as in your version */}
          {/* Languages */}
          <div>
            <h3 className="text-slate-200 font-semibold mb-2">Languages</h3>
            <div className="flex flex-wrap gap-2 text-xs">
              {["Python", "C", "C++", "JavaScript", "HTML", "CSS"].map((t) => (
                <span
                  key={t}
          ...
          {/* Frameworks */}
          <div>
            <h3 className="text-slate-200 font-semibold mb-2">Frameworks</h3>
            <div className="flex flex-wrap gap-2 text-xs">
              {[
                "Django",
                "Angular",
          ...
          {/* Databases */}
          <div>
            <h3 className="text-slate-200 font-semibold mb-2">Databases</h3>
            <div className="flex flex-wrap gap-2 text-xs">
              {["MySQL", "MariaDB", "MongoDB"].map((t) => (
                <span
                  key={t}
                  className="px-2 py-1 rounded-full bg-slate-800 border border-slate-700"
                >
          ...
          {/* Libraries */}
          <div>
            <h3 className="text-slate-200 font-semibold mb-2">Libraries</h3>
            <div className="flex flex-wrap gap-2 text-xs">
              {["Pandas", "bs4", "Selenium", "Ajax"].map((t) => (
                <span
                  key={t}
                  className="px-2 py-1 rounded-full bg-slate-800 border border-slate-700"
                >
          ...
          {/* Soft skills */}
          <div>
            <h3 className="text-slate-200 font-semibold mb-2">Soft Skills</h3>
            <div className="flex flex-wrap gap-2 text-xs">
              {["Communication", "Problem Solving", "Creativity"].map((t) => (
                <span
                  key={t}
                  className="px-2 py-1 rounded-full bg-slate-800 border border-slate-700"
                >
